...
| `npm run check` | Syntax-checks browser and server modules before deployment. |
...
- `test/ui-safety.test.mjs` checks production browser security headers and core accessibility markup.
